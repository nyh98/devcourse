...
export default function EditModal() {
  const editingState = useTypeSelector(state => state.modal);
  ...
  const handleUpdate = () => {
    dispatch(updateTask({ boardId: editingState.boardId, listId: editingState.listId, task: editingState.task }));
  ...
  const handleDelete = () => {
    dispatch(
      deleteTask({ boardId: editingState.boardId, listId: editingState.listId, taskId: editingState.task.taskId })
    );
